...
def arg_parser():
	...
	parser.add_argument('-nr', '--n_rollout_samples', metavar = 'R', type = int, default = 128, help = 'baseline rollout number of samples')
	parser.add_argument('-e', '--epochs', metavar = 'E', type = int, default = 400, help = 'total number of samples = epochs * number of samples')
